...
namespace CS2Mod
{
    ...
    {
        public static ILog log = LogManager.GetLogger($"{nameof(CS2Mod)}.{nameof(Mod)}").SetShowsErrorsInUI(false);
        ...
        public void OnLoad(UpdateSystem updateSystem)
        {
            ...
            AssetDatabase.global.LoadSettings(nameof(CS2Mod), m_Setting, new Setting(this));
        }
